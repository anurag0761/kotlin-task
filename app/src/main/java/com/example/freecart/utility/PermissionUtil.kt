package com.example.freecart.utility
...
class PermissionUtil() {
    ...
    fun  request(permissionCallback: PermissionCallback?) {
        ...
        if (checkSelfPermission(permissions) == false) {
            ...
            if (activity != null) ActivityCompat.requestPermissions(
                activity!!,
                filterNotGrantedPermission(permissions)!!, REQUEST_CODE
            )
        } else {
            Log.i(TAG, "PERMISSION: Permission Granted")
            if (mPermissionCallback != null) mPermissionCallback!!.onPermissionGranted(REQUEST_CODE)
        }
    }
    ...
    interface PermissionCallback {
        ...
        fun onIndividualPermissionGranted(grantedPermission: Array<String>?, requestCode: Int)
        fun onPermissionDenied(requestCode: Int)
        fun onPermissionDeniedBySystem(requestCode: Int)
    }
